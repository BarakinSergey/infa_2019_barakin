...
class gun():
    ...
    def __init__(self):
        ...
        self.f2_on = 0
        self.an = 1
        self.idcircle = canv.create_oval(
                xcreate - 10,
                ycreate - 10,
                xcreate + 10,
                ycreate + 10,
        ...
        self.idline = canv.create_line(xcreate,ycreate,xcreate+30,ycreate-30,width=7)
    ...
    def moveg(self): #moves the gun
        ...
        global vycreate
        #ground
        if ycreate >= 570-15 or ycreate <= 10:
            vycreate = -0.5*vycreate
            #vxtarget[num] = vxtarget[num]
            xcreate += vxcreate
            ycreate += vycreate
            canv.move(self.idline,vxcreate,vycreate)
            canv.move(self.idcircle,vxcreate,vycreate)
            #print(vxcreate,vycreate)
        #right wall
        if xcreate >= 800-15 or xcreate <= 10:
            #vycreate = -vycreate
    ...
    def targetting(self, event=0):
        ...
        if self.f2_on:
            canv.itemconfig(self.idline, fill='orange')
        else:
            canv.itemconfig(self.idline, fill='black')
        canv.coords(self.idline, xcreate, ycreate,
...
class target():
    def __init__(self):
        ...
        for i in range(0,TARG):
            idt[i] = canv.create_oval(-10,-10,0,0)
